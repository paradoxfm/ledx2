...
namespace LEDX.Components.ColorPickerControls {
	...
	/// </summary>
	public partial class ColorPickerFull : Grid {
		...
		public static DependencyProperty InitialColorProperty = DependencyProperty.Register("InitialColor", typeof(Color), ClassType, new FrameworkPropertyMetadata(Colors.Transparent, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnInitialColorChanged));
		...
		public static DependencyProperty SelectedColorProperty = DependencyProperty.Register("SelectedColor", typeof(Color), ClassType, new FrameworkPropertyMetadata(Colors.Transparent, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnSelectedColorChanged));
		[Category("ColorPicker")]
		...
		public ColorPickerFull() {
			InitializeComponent();
			Binding bnd = new Binding("Color");
			bnd.Source = colorSelector;
			SetBinding(SelectedColorProperty, bnd);
		}
	}
}
