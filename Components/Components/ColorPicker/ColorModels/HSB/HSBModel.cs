	...
	public class HSBModel {
		...
		public Color Color(double hue, double saturation, double brightness) {
			...
			return System.Windows.Media.Color.FromRgb(
					Convert.ToByte(r < 0 ? 0 : r * 255.0),
					Convert.ToByte(g < 0 ? 0 : g * 255.0),
					Convert.ToByte(b < 0 ? 0 : b * 255.0));
		}

		public double HComponent(Color color) {
			return System.Drawing.Color.FromArgb(255, color.R, color.G, color.B).GetHue();
		}
